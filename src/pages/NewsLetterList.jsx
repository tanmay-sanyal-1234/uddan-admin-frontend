...
import { useGetNewLetterListAdmin, useNewsletterDelete } from "@/hooks/inqueryHook";
...
function NewsLetterList() {
    ...
    const { mutateAsync: newsletterDeleteUpdate } = useNewsletterDelete();
    ...
    const handleDelete = async(id) => {
        setLoading(true);
        await newsletterDeleteUpdate(id, {
            onSuccess: (data) => {
                setLoading(false);
